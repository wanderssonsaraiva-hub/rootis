...
if(patientBookingForm){
  ...
  patientBookingForm.addEventListener('submit',e=>{
    ...
    e.target.reset();renderPatientPortal();publicSelected=null;document.getElementById('chosenSlot').textContent='Nenhum horário selecionado.';
  });
}
